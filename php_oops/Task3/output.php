...
class form{
public $firstname, $lastname,$fullname,$file_name,$temp_name,$file_path,$subject;
//constructor for set values 
function __construct($first,$last,$file_name,$temp_name,$file_path,$subject) {
...
$user1=new form($fname,$lname,$file_name,$file_temp,$file_path,$subject);//object for form class 
$user1->checkInput();
$user1->displayImage();
$user1->displayMarks();
